  ...
  return (
    <div className="w-full bg-gray-50">
      ...
      <div className="relative w-full">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-purple-900/80 to-purple-600/50 flex items-end p-8">
          <div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-gray-800 mb-6 flex items-center">
            <FaBusinessTime className="mr-3 text-purple-600" />
            Our Event Services
          </h2>
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-2/3 mb-6 md:mb-0 md:pr-8">
              <h2 className="text-2xl font-bold mb-4 flex items-center">
                <FaClipboardCheck className="mr-3 text-yellow-300" />
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  <FaCalendarAlt className="mt-1 mr-3 text-purple-200 flex-shrink-0" />
                  <span>Venue selection and booking</span>
                </li>
                <li className="flex items-start">
                  <FaPhotoVideo className="mt-1 mr-3 text-purple-200 flex-shrink-0" />
                  <span>Stage design and audio-visual production</span>
                </li>
                <li className="flex items-start">
                  <FaGlassCheers className="mt-1 mr-3 text-purple-200 flex-shrink-0" />
                  <span>Catering and hospitality management</span>
                </li>
                <li className="flex items-start">
                  <FaMicrophone className="mt-1 mr-3 text-purple-200 flex-shrink-0" />
                  <span>Entertainment and talent coordination</span>
                </li>
              </ul>
            </div>
            <div className="md:w-1/3 bg-white/10 p-6 rounded-xl backdrop-blur-sm">
              <h3 className="font-semibold mb-3 text-yellow-300">Why Choose Us</h3>
              <ul className="space-y-2 text-sm">
                <li className="flex items-start">
                  <span className="bg-purple-500 text-white rounded-full w-5 h-5 flex items-center justify-center mr-2 flex-shrink-0">1</span>
                  <span>Local market expertise</span>
                </li>
                <li className="flex items-start">
                  <span className="bg-purple-500 text-white rounded-full w-5 h-5 flex items-center justify-center mr-2 flex-shrink-0">2</span>
                  <span>Vendor network</span>
                </li>
                <li className="flex items-start">
                  <span className="bg-purple-500 text-white rounded-full w-5 h-5 flex items-center justify-center mr-2 flex-shrink-0">3</span>
                  <span>Attention to detail</span>
                </li>
                <li className="flex items-start">
                  <span className="bg-purple-500 text-white rounded-full w-5 h-5 flex items-center justify-center mr-2 flex-shrink-0">4</span>
        ...
        <div className="text-center py-8">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button className="bg-purple-600 hover:bg-purple-700 text-white font-semibold py-3 px-8 rounded-full shadow-lg transition-colors">
              Get a Quote
            </button>
            <button className="bg-white border border-purple-600 text-purple-600 font-semibold py-3 px-8 rounded-full shadow-lg transition-colors hover:bg-purple-50">
              View Portfolio
            </button>
          </div>
        </div>
